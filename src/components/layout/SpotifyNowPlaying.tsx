...
export default async function SpotifyNowPlaying() {
  ...
  return (
    <div className="group/spotify bg-white rounded-lg shadow-sm p-6 transition-all hover:shadow-md border border-himalaya-mist">
      ...
      <div className="flex flex-col md:flex-row md:items-start items-center gap-6">
        ...
        <div className="flex flex-col items-center md:items-start md:justify-center md:h-40 min-w-0">
          {track ? (
            <>
              <p className="text-xs font-mono text-himalaya-stone mb-1 mt-4 md:mt-0">
                {track.isPlaying ? "now playing" : "last played"}
              </p>
              <MarqueeText className="text-lg font-medium w-full">
                {track.title}
              </MarqueeText>
              <MarqueeText className="text-himalaya-shadow w-full">
                {track.artist}
              </MarqueeText>
              <MarqueeText className="text-xs text-himalaya-shadow mt-1 mb-3 md:mb-4 w-full">
                {track.album}
              </MarqueeText>
              <Link
                href={track.songUrl}
            ...
            <>
              <p className="text-himalaya-shadow text-center md:text-left mt-4 md:mt-0">
